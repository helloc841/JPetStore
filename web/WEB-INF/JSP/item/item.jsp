...
<%
    ...
    String itemname = (String) request.getAttribute("itemnames");
    String [] itemnames = null;
    if (itemname != null){
        itemnames = itemname.split("/");
    }
    String price = (String) request.getAttribute("prices");
    String [] prices = null;
    if (price != null)
    prices = price.split("/");
%>
...
<div id="Content">
    ...
    <div id="BackLink">
        ...
        <a href="<%=basePath%>/web/category?Category=<%=Category%>">Return to <%=Category%>></a>
        ...
        <table>
            ...
            <%
                for (int i = 0 ; i < itemnames.length ; i++){
                    String url_detail = basePath+"/web/itemdetail?itemid="+itemids[i]+"&Category="+Category;
                    String url_cart = basePath+"/web/cart?itemid="+itemids[i]+"&Category="+Category+"&productid="+productid;
                    out.println("<tr>\n" +
                            "                <td>\n" +
