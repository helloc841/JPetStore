...
public class UpdateMyAccountServlet extends HttpServlet {
    ...
    private static final String URL_LOGINMAINPAGE = "loginmainpage";
    private static final String URL_MYACCOUNT = "myaccount";
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String msg = logandregservice.setAccount(user);
        req.setAttribute("username",user.getUsername());
        if (msg.equals("success")){
            req.getRequestDispatcher(URL_LOGINMAINPAGE).forward(req,resp);
        }
        else {
