...
<div id="Content">
    ...
    <div id="BackLink">
        ...
        <a href="<%=basePath%>/web/mainpage">Return to Main Menu </a>
        ...
        <table>
            ...
            <%
                ...
                for (int i = 0 ; i < length ; i++){
                    out.println("<tr>\n" +
                                "<td><a href="+basePath+"/web/item?productid="+productids[i]+"&Category="+request.getAttribute("Category")+" >"+productids[i]+"</a></td>\n" +
                                "<td>"+names[i]+"</td>\n"+
                                "</tr>");
                }
                if (productids.length > 4){
                    out.println("<tr><td colspan=\"2\">\n" +
                            "<a class=\"Button\" href=" + basePath+"/web/category?Category="+request.getAttribute("Category")+"&count="+count+">Next &gt;&gt;</a>\n" +
                                "</td></tr>");
                }
                if (count == 0){
                    out.println("<tr><td colspan=\"2\">\n" +
