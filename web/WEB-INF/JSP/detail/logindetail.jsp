...
<div id="Content">
    ...
    <div id="BackLink">
        ...
        <a href="<%=basePath%>/web/item?Category=<%=Category%>&productid=<%=productid%>&username=<%=username%>">Return to <%=itemkind%></a>
    ...
    <div id="Catalog">
        ...
        <table>
            ...
            <tr><td>
                <a href="<%=basePath%>/web/cart?itemid=<%=itemid%>&username=<%=username%>&Category=<%=Category%>&productid=<%=productid%>" class="Button">Add to Cart</a>
            </td></tr>
        </table>
